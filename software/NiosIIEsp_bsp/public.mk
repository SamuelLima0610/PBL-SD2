...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../arquiteturaUart.sopcinfo
...
# Design Name 
# setting SOPC_NAME is arquiteturaUart
SOPC_NAME := arquiteturaUart
...
# The SOPC System ID 
# setting SOPC_SYSID is 775
SOPC_SYSID_FLAG += --id=775
ELF_PATCH_FLAG  += --id 775
...
# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1542127774
SOPC_SYSID_FLAG += --timestamp=1542127774
ELF_PATCH_FLAG  += --timestamp 1542127774
